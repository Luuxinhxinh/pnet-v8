...
| :--- | :---: | :--- | :--- |
| **Sửa logic khởi động QEMU/IOL/Docker** | G01 | [`/opt/unetlab/wrappers/`](../opt/unetlab/wrappers), [`/opt/unetlab/html/includes/functions.php`](../opt/unetlab/html/includes/functions.php) | [`F02-node-start-lifecycle.md`](02-features/node-lifecycle/F02-node-start-lifecycle.md) |
| **Thêm hoặc sửa loại card mạng, cổng nối dây** | G02 | [`/opt/unetlab/html/devices/interfc.php`](../opt/unetlab/html/devices/interfc.php), [`/opt/unetlab/html/includes/api_networks.php`](../opt/unetlab/html/includes/api_networks.php) | [`F08-network-bridge-cloud.md`](02-features/network-topology/F08-network-bridge-cloud.md) |
| **Sửa giao diện vẽ Canvas hoặc kéo thả dây** | G02 | [`/opt/unetlab/html/themes/default/js/javascript.js`](../opt/unetlab/html/themes/default/js/javascript.js) | [`F10-canvas-topology-engine.md`](02-features/network-topology/F10-canvas-topology-engine.md) |
| **Khắc phục lỗi WebConsole Telnet không gõ được** | G03 | [`/opt/pnet-webconsole/backend/http_ws_bridge.py`](../opt/pnet-webconsole/backend/http_ws_bridge.py) | [`F15-webconsole-websocket-bridge.md`](02-features/console-access/F15-webconsole-websocket-bridge.md) |
| **Khắc phục lỗi Guacamole VNC màn hình đen** | G03 | [`/opt/pnet-webconsole/backend/guacamole-lite-server.js`](../opt/pnet-webconsole/backend/guacamole-lite-server.js) | [`F16-guacamole-html5-vnc-rdp.md`](02-features/console-access/F16-guacamole-html5-vnc-rdp.md) |
| **Sửa cấu trúc đọc ghi file Lab XML `.unl`** | G04 | [`/opt/unetlab/html/includes/__lab.php`](../opt/unetlab/html/includes/__lab.php), [`/opt/unetlab/html/includes/__node.php`](../opt/unetlab/html/includes/__node.php) | [`F21-lab-xml-parser-serializer.md`](02-features/lab-management/F21-lab-xml-parser-serializer.md) |
| **Sửa daemon điều phối cụm Satellite & Broker** | G05 | [`/opt/unetlab/scripts/pnetlab-brokerd.py`](../opt/unetlab/scripts/pnetlab-brokerd.py), [`/opt/unetlab/html/includes/broker.php`](../opt/unetlab/html/includes/broker.php) | [`F26-cluster-broker-daemon.md`](02-features/cluster-satellite/F26-cluster-broker-daemon.md) |
| **Sửa cơ chế tạo độ trễ NetEm đường dây cáp** | G06 | [`/opt/unetlab/html/pnq-linkwatch.php`](../opt/unetlab/html/pnq-linkwatch.php), [`/opt/unetlab/scripts/linkwatch.py`](../opt/unetlab/scripts/linkwatch.py) | [`F31-netem-link-impairment.md`](02-features/netem-telemetry/F31-netem-link-impairment.md) |
| **Chỉnh sửa thuật toán vẽ đường bao OSPF/BGP** | G07 | [`/opt/unetlab/scripts/pnet_routeoverlay.py`](../opt/unetlab/scripts/pnet_routeoverlay.py) | [`F37-routing-protocol-overlay.md`](02-features/protocol-overlay/F37-routing-protocol-overlay.md) |
| **Bổ sung tiêu chí chấm bài thi lab tự động** | G08 | [`/opt/unetlab/html/includes/lab_validation_probe.php`](../opt/unetlab/html/includes/lab_validation_probe.php) | [`F45-validation-probe-engine.md`](02-features/lab-validation/F45-validation-probe-engine.md) |
| **Bổ sung template thiết bị mạng mới** | G09 | [`/opt/unetlab/html/templates/`](../opt/unetlab/html/templates), [`/opt/unetlab/html/devices-factory/api.php`](../opt/unetlab/html/devices-factory/api.php) | [`F48-device-templates-schema.md`](02-features/templates-images/F48-device-templates-schema.md) |
| **Tích hợp thêm Tool gọi lệnh cho AI Agent MCP**| G10 | [`/opt/unetlab/scripts/pnet_mcp_server.py`](../opt/unetlab/scripts/pnet_mcp_server.py) | [`F54-ai-agent-mcp-server.md`](02-features/automation-ai/F54-ai-agent-mcp-server.md) |
| **Sửa logic phân quyền người dùng và POD** | G11 | [`/opt/unetlab/html/includes/api_authentication.php`](../opt/unetlab/html/includes/api_authentication.php) | [`F59-user-rbac-pod-isolation.md`](02-features/user-security/F59-user-rbac-pod-isolation.md) |
| **Bổ sung bài kiểm tra tự chẩn đoán PNet Doctor**| G12 | [`/opt/unetlab/html/includes/doctor.php`](../opt/unetlab/html/includes/doctor.php), [`/opt/unetlab/scripts/pnet_doctor.py`](../opt/unetlab/scripts/pnet_doctor.py) | [`F64-system-doctor-diagnostics.md`](02-features/system-platform/F64-system-doctor-diagnostics.md) |
