...
flowchart TD
    ...
    subgraph SG_image_apis [" 📦 Tầng Backend Image & Template APIs (PHP) "]
        direction TB
        template_api["<b>api_templatedefaults.php</b><br/><i>(Template Config Service)</i><br/>Quét thư mục [`[`/opt/unetlab/html/templates`](../../opt/unetlab/html/templates)](../../html/templates)/"]:::api
    ...
    ishare_api -->|"Kích hoạt worker nền<br/><i>[nohup [`[`/opt/unetlab/scripts/workers/ishare2.sh`](../../opt/unetlab/scripts/workers/ishare2.sh)](../../scripts/workers/ishare2.sh) &]</i>"| ishare_worker
