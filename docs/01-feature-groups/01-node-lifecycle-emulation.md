...
| [`/opt/unetlab/html/includes/api_nodes.php`](../../opt/unetlab/html/includes/api_nodes.php)](../../html/includes/api_nodes.php) | PHP | Các hàm xử lý nghiệp vụ node: `apiAddLabNode()`, `apiEditLabNode()`, `apiDeleteLabNode()`, `apiStartLabNode()`, `apiStopLabNode()`, `apiWipeLabNode()` |
...
| [`/opt/unetlab/html/includes/functions.php`](../../opt/unetlab/html/includes/functions.php) | PHP | Tầng điều phối hạ tầng: `createRunningPath()`, `getNodeStatus()`, `checkRunningNodeLimit()`, kiểm tra quyền hạn và dọn dẹp Wireshark |
...
flowchart TD
    ...
    api_nodes -->|"Thực thi hạ tầng<br/><i>[apiStartLabNode() / apiStopLabNode()]</i>"| functions_core
