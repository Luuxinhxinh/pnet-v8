...
| :--- | :--- | :--- |
| [`html/includes/api_networks.php`](../../html/includes/api_networks.php) | PHP | Nghiệp vụ mạng: `apiNetworkAdd()`, `apiNetworkEdit()`, `apiNetworkDelete()` |
| [`html/includes/__network.php`](../../html/includes/__network.php) | PHP | Domain Object `Network`: Đọc ghi thuộc tính mạng trong Lab XML, gán loại mạng (bridge, pnet) |
| [`html/includes/api_topology.php`](../../html/includes/api_topology.php) | PHP | Trả về cấu trúc đồ thị mạng hoàn chỉnh (nodes, links, interfaces) cho Canvas render |
| [`html/includes/api_pictures.php`](../../html/includes/api_pictures.php) | PHP | Xử lý tải ảnh nền, cắt ảnh, lưu trữ và ánh xạ vị trí hotspot |
| [`html/includes/api_textobjects.php`](../../html/includes/api_textobjects.php)| PHP | Quản lý các đối tượng chữ chú thích (Text Objects) trên Canvas |
| [`html/themes/default/js/javascript.js`](../../html/themes/default/js/javascript.js)| JavaScript | Tệp điều khiển chính Canvas, xử lý mouse down/move/up, vẽ icon node và dây mạng |
| [`html/themes/default/js/pnetlab-shape-draw.js`](../../html/themes/default/js/pnetlab-shape-draw.js)| JavaScript | Bộ công cụ vẽ vector hình khối (Shapes, Rectangles, Circles) |
| [`html/themes/default/js/pnetlab-align-distribute.js`](../../html/themes/default/js/pnetlab-align-distribute.js)| JavaScript | Thuật toán tính toán tọa độ căn lề và dàn đều khoảng cách node |
| [`html/themes/default/js/pnetlab-node-duplicate.js`](../../html/themes/default/js/pnetlab-node-duplicate.js)| JavaScript | Xử lý sao chép node kèm cấu hình và giao diện kết nối |
