...
- Tầng Cầu nối WebConsole & WebSockets ([`pnet-webconsole/backend`](../../pnet-webconsole/backend)/`)
...
| **Tầng WebConsole** | [`pnet-webconsole/backend`](../../pnet-webconsole/backend)/` | Node.js, Python asyncio, websockets | `guacd`, raw TCP telnet sockets |
