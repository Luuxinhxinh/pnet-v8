...
| :--- | :--- | :--- |
| `/opt/unetlab/html/api.php` | `$app->put("/api/labs/session/network/manage")` | API quản lý việc gán interface vào network |
| `/opt/unetlab/html/includes/api_networks.php` | `apiNetworkP2PConnect()` | Xử lý logic tự sinh mạng p2p |
| `/opt/unetlab/html/themes/default/js/javascript.js` | `connectNodes()` | Bắt sự kiện thả dây giữa 2 node trên UI |
