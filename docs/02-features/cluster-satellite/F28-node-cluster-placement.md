...
| :--- | :--- | :--- |
| [`html/themes/default/js/pnetlab-node-runon.js`](../../../html/themes/default/js/pnetlab-node-runon.js) | `renderRunOnModal()` | Modal chọn máy chủ chạy node |
| [`html/themes/default/js/pnetlab-sat-badge.js`](../../../html/themes/default/js/pnetlab-sat-badge.js) | `drawSatelliteBadge()` | Vẽ huy hiệu tên host lên icon node |
| [`html/pnq-placements.php`](../../../html/pnq-placements.php) | PHP API | Lấy và cập nhật bảng vị trí cluster placement |
