...
5. **Kích hoạt Wrapper Nhị phân**:
   - PHP API gọi dòng lệnh hệ thống: `sudo [`scripts/unl_wrapper.php`](../../../scripts/unl_wrapper.php) -a start -T <tenant_pod> -D <node_id>`.
...
| :--- | :--- | :--- |
| [`html/api.php`](../../../html/api.php) | `$app->post("/api/labs/session/nodes/(:action)")` | Định tuyến hành động `start` |
| [`html/includes/api_nodes.php`](../../../html/includes/api_nodes.php) | `apiNodeStart()` | Kiểm tra trạng thái và điều phối khởi động |
| [`html/includes/functions.php`](../../../html/includes/functions.php) | `nodeStart()` | Sinh thư mục tmp, chuẩn bị đĩa và gọi unl_wrapper |
| [`scripts/unl_wrapper.php`](../../../scripts/unl_wrapper.php) | `startNode()` | Script CLI phân tích loại thiết bị và gọi wrapper C |
| [`wrappers/qemu_wrapper`](../../../wrappers/qemu_wrapper) | C main process | Tạo TAP, cấu hình qemu cmdline và khởi chạy QEMU |
