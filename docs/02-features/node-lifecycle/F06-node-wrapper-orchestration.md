...
| :--- | :--- | :--- |
| [`wrappers/qemu_wrapper`](../../../wrappers/qemu_wrapper) | C binary | Wrapper cho QEMU/KVM |
| [`wrappers/iol_wrapper`](../../../wrappers/iol_wrapper) | C binary | Wrapper cho Cisco IOL |
| [`wrappers/docker_wrapper`](../../../wrappers/docker_wrapper) | C binary | Wrapper cho Docker container |
| [`wrappers/unl_wrapper`](../../../wrappers/unl_wrapper) | C binary | Wrapper điều phối chung |
| [`scripts/unl_wrapper.php`](../../../scripts/unl_wrapper.php) | PHP CLI | Cầu nối sinh dòng lệnh gọi wrapper |

## 5. Input / Output & Xử lý Ngoại lệ
- **Input CLI**:
  ```bash
  [`wrappers/qemu_wrapper`](../../../wrappers/qemu_wrapper) -T 0 -D 1 -t "CSR1000v" -F /opt/qemu/bin/qemu-system-x86_64 -d 1 -- -smp 2 -m 4096 ...
  ```
