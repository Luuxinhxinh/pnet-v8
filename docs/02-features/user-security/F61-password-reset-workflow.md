...
| :--- | :--- | :--- |
| [`html/includes/password_reset.php`](../../../html/includes/password_reset.php) | `requestPasswordReset()`, `consumePasswordReset()` | Xử lý logic đặt lại mật khẩu |
| [`html/includes/smtp_mailer.php`](../../../html/includes/smtp_mailer.php) | `sendPasswordResetMail()` | Gửi email khôi phục mật khẩu |
| [`html/reset-password`](../../../html/reset-password)/` | HTML / JS Views | Giao diện trang nhập email và đặt mật khẩu mới |
