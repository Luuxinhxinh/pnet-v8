...
| :--- | :--- | :--- |
| `/opt/unetlab/html/includes/password_reset.php` | `requestPasswordReset()`, `consumePasswordReset()` | Xử lý logic đặt lại mật khẩu |
| `/opt/unetlab/html/includes/smtp_mailer.php` | `sendPasswordResetMail()` | Gửi email khôi phục mật khẩu |
| `/opt/unetlab/html/reset-password/` | HTML / JS Views | Giao diện trang nhập email và đặt mật khẩu mới |
