...
| :--- | :--- | :--- |
| [`html/pnq-roce.php`](../../../html/pnq-roce.php) | PHP API (10KB) | Endpoint phục vụ dữ liệu phân tích RoCE |
| [`html/themes/default/js/pnetlab-roce-lab.js`](../../../html/themes/default/js/pnetlab-roce-lab.js) | JavaScript | Giao diện đồ thị phân tích RDMA |
