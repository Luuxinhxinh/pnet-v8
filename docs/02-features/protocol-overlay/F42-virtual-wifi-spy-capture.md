...
| :--- | :--- | :--- |
| [`/opt/unetlab/scripts/vwifi-spy-capture.py`](../../../opt/unetlab/scripts/vwifi-spy-capture.py)](../../../scripts/vwifi-spy-capture.py) | Python Script (5.7KB) | Bắt gói tin không gian và chèn Radiotap header |
| [`/opt/unetlab/scripts/airhandler.py`](../../../opt/unetlab/scripts/airhandler.py)](../../../scripts/airhandler.py) | Python Daemon | Cung cấp luồng frame vô tuyến thô |
