...
1. **Duyệt Thư viện Biểu tượng**:
   - `images-icons/api.php` quét toàn bộ thư mục [`html/images/icons`](../../../html/images/icons)/`.
...
| :--- | :--- | :--- |
| [`html/images-icons/api.php`](../../../html/images-icons/api.php) | PHP API | Quản lý duyệt và tải lên icon |
| [`html/themes/default/js/pnetlab-template-icons.json`](../../../html/themes/default/js/pnetlab-template-icons.json)| Config JSON | Danh mục ánh xạ icon thiết bị |
