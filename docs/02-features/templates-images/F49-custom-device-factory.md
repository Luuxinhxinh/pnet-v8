...
2. **Sinh File Định nghĩa Template**:
   ...
   - Tự động sinh mã nguồn PHP template chuẩn và ghi vào [`html/templates`](../../../html/templates)/<template_name>.php`.
...
| :--- | :--- | :--- |
| [`html/devices-factory/api.php`](../../../html/devices-factory/api.php) | PHP API | Endpoint tiếp nhận và sinh file template |
| [`html/main/js/devices.js`](../../../html/main/js/devices.js) | JavaScript | Giao diện Device Factory Wizard |
