...
| :--- | :--- | :--- |
| [`/opt/unetlab/html/ishare2/api.php`](../../../opt/unetlab/html/ishare2/api.php)](../../../html/ishare2/api.php) | PHP API | API giao tiếp với kho IShare2 Cloud |
| [`/opt/unetlab/scripts/workers/ishare2.sh`](../../../opt/unetlab/scripts/workers/ishare2.sh)](../../../scripts/workers/ishare2.sh) | Shell Script (7.8KB) | Worker chạy ngầm tải và giải nén image |
| [`/opt/unetlab/html/main/js/images.js`](../../../opt/unetlab/html/main/js/images.js)](../../../html/main/js/images.js) | JavaScript | Giao diện kho IShare2 Store |
