...
| :--- | :--- | :--- |
| [`html/pnq-sysmon.php`](../../../html/pnq-sysmon.php) | PHP API | Cung cấp JSON thông số máy chủ |
| [`scripts/pnq-telemetryd.py`](../../../scripts/pnq-telemetryd.py) | Python Daemon (16KB) | Daemon gom chỉ số và lưu lịch sử |
| [`html/themes/default/js/pnetlab-sysmon.js`](../../../html/themes/default/js/pnetlab-sysmon.js) | JavaScript | Vẽ đồng hồ đo tài nguyên trên giao diện |
