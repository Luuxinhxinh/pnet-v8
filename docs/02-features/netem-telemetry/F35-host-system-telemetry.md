...
| :--- | :--- | :--- |
| `/opt/unetlab/html/pnq-sysmon.php` | PHP API | Cung cấp JSON thông số máy chủ |
| `/opt/unetlab/scripts/pnq-telemetryd.py` | Python Daemon (16KB) | Daemon gom chỉ số và lưu lịch sử |
| `/opt/unetlab/html/themes/default/js/pnetlab-sysmon.js` | JavaScript | Vẽ đồng hồ đo tài nguyên trên giao diện |
