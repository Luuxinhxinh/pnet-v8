...
| :--- | :--- | :--- |
| [`/opt/unetlab/scripts/pnetlab-linkwatchd.py`](../../../opt/unetlab/scripts/pnetlab-linkwatchd.py)](../../../scripts/pnetlab-linkwatchd.py) | `LinkWatchDaemon`, `listen_netlink()` | Daemon lắng nghe netlink sockets |
| [`/opt/unetlab/html/themes/default/js/pnetlab-network-watcher.js`](../../../opt/unetlab/html/themes/default/js/pnetlab-network-watcher.js)](../../../html/themes/default/js/pnetlab-network-watcher.js)| JavaScript | Client lắng nghe sự kiện link state trên UI |
