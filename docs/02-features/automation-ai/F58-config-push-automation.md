...
| :--- | :--- | :--- |
| [`scripts/pnet-pushconfig.py`](../../../scripts/pnet-pushconfig.py) | Python Script (11KB) | Đẩy cấu hình đa luồng vào danh sách router |
| [`scripts/pnet-showcmd.py`](../../../scripts/pnet-showcmd.py) | Python Script (12KB) | Thu thập kết quả lệnh show từ một router |
| [`scripts/pnet_showmany.py`](../../../scripts/pnet_showmany.py) | Python Script (3.3KB) | Thu thập lệnh show từ nhiều router đồng thời |
