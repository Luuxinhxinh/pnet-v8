...
| :--- | :--- | :--- |
| [`html/themes/default/js/pnetlab-ai-builder.js`](../../../html/themes/default/js/pnetlab-ai-builder.js) | JavaScript | Giao diện khung chat widget AI nổi |
| [`scripts/mcp/ai_lab_agent.py`](../../../scripts/mcp/ai_lab_agent.py) | Python Script (28KB) | Động cơ agent thông minh phân tách lệnh |
| [`html/mcp/api.php`](../../../html/mcp/api.php) | PHP API | Cầu nối API giao tiếp với AI Agent |
