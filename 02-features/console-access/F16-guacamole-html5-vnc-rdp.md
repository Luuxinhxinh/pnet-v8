...
| :--- | :--- | :--- |
| `/opt/pnet-webconsole/backend/guacamole-lite-server.js` | Node.js Server | Chuyển đổi WebSocket sang giao thức guacd |
| `/etc/pnet-webconsole/guac.env` | Config env | Chứa thông tin đăng nhập MySQL guacdb và port guacd |
| `/opt/unetlab/html/rdp/index.php` | PHP | Trang nhúng trình xem đồ họa Guacamole |
