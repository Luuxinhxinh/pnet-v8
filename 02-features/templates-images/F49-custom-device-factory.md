...
2. **Sinh File Định nghĩa Template**:
   ...
   - Tự động sinh mã nguồn PHP template chuẩn và ghi vào `/opt/unetlab/html/templates/<template_name>.php`.
...
| :--- | :--- | :--- |
| `/opt/unetlab/html/devices-factory/api.php` | PHP API | Endpoint tiếp nhận và sinh file template |
| `/opt/unetlab/html/main/js/devices.js` | JavaScript | Giao diện Device Factory Wizard |
