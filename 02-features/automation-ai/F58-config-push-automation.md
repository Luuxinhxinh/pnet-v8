...
| :--- | :--- | :--- |
| `/opt/unetlab/scripts/pnet-pushconfig.py` | Python Script (11KB) | Đẩy cấu hình đa luồng vào danh sách router |
| `/opt/unetlab/scripts/pnet-showcmd.py` | Python Script (12KB) | Thu thập kết quả lệnh show từ một router |
| `/opt/unetlab/scripts/pnet_showmany.py` | Python Script (3.3KB) | Thu thập lệnh show từ nhiều router đồng thời |
