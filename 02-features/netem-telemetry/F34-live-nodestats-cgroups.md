...
| :--- | :--- | :--- |
| `/opt/unetlab/html/pnq-nodestats.php` | PHP API | Endpoint trả về dữ liệu tài nguyên node |
| `/opt/unetlab/html/pnq-nodestats.sh` | Shell Script | Script đọc nhanh các file trong sysfs cgroup |
| `/opt/unetlab/html/themes/default/js/pnetlab-node-stats.js` | JavaScript | Vẽ thanh mini HUD hiển thị thông số trên Canvas |
