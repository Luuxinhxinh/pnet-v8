...
| :--- | :--- | :--- |
| `/opt/unetlab/html/includes/api_authentication.php` | `apiAuthentication()`, `authorization()` | Xác thực thông tin đăng nhập và cấp token |
| `/opt/unetlab/html/api.php` | Middleware `$app->hook('slim.before')` | Bộ lọc kiểm tra phiên trước mọi API |
