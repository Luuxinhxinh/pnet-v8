...
1. **Lời gọi Setuid**:
   - `unl_wrapper.php` gọi thực thi các file nhị phân trong `/opt/unetlab/wrappers/`:
...
| :--- | :--- | :--- |
| `/opt/unetlab/wrappers/qemu_wrapper` | C binary | Wrapper cho QEMU/KVM |
| `/opt/unetlab/wrappers/iol_wrapper` | C binary | Wrapper cho Cisco IOL |
| `/opt/unetlab/wrappers/docker_wrapper` | C binary | Wrapper cho Docker container |
| `/opt/unetlab/wrappers/unl_wrapper` | C binary | Wrapper điều phối chung |
| `/opt/unetlab/scripts/unl_wrapper.php` | PHP CLI | Cầu nối sinh dòng lệnh gọi wrapper |

## 5. Input / Output & Xử lý Ngoại lệ
- **Input CLI**:
  ```bash
  /opt/unetlab/wrappers/qemu_wrapper -T 0 -D 1 -t "CSR1000v" -F /opt/qemu/bin/qemu-system-x86_64 -d 1 -- -smp 2 -m 4096 ...
  ```
