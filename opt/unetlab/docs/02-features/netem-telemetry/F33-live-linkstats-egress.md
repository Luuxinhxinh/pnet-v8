...
| :--- | :--- | :--- |
| [`[`/opt/unetlab/html/pnq-linkstats.php`](../../../html/pnq-linkstats.php)](../../../html/pnq-linkstats.php) | PHP API | Đọc sysfs và tính toán tốc độ bit/s |
| [`[`/opt/unetlab/html/themes/default/js/pnetlab-egress-glow.js`](../../../html/themes/default/js/pnetlab-egress-glow.js)](../../../html/themes/default/js/pnetlab-egress-glow.js) | `animateGlow()`, `renderParticles()` | Động cơ vẽ hạt sáng chuyển động |
