...
| :--- | :--- | :--- |
| [`[`/opt/unetlab/html/themes/default/js/pnetlab-netem-advanced.js`](../../../html/themes/default/js/pnetlab-netem-advanced.js)](../../../html/themes/default/js/pnetlab-netem-advanced.js) | `openNetemModal()`, `applyImpairment()` | Hộp thoại cấu hình thanh trượt NetEm |
| [`[`/opt/unetlab/html/pnq-linkwatch.php`](../../../html/pnq-linkwatch.php)](../../../html/pnq-linkwatch.php) | PHP API | Tiếp nhận và biên dịch tham số sang lệnh `tc` |
| [`[`/opt/unetlab/scripts/pnetlab-linkwatchd.py`](../../../scripts/pnetlab-linkwatchd.py)](../../../scripts/pnetlab-linkwatchd.py) | Python Daemon | Kiểm tra và duy trì qdisc trên interface |
