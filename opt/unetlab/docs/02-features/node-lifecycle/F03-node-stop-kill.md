...
3. **Gửi Tín hiệu Dừng (Graceful Signal)**:
   - Gọi wrapper: `sudo [`[`/opt/unetlab/scripts/unl_wrapper.php`](../../../scripts/unl_wrapper.php)](../../../scripts/unl_wrapper.php) -a stop -T <pod> -D <node_id>`.
...
| :--- | :--- | :--- |
| [`[`/opt/unetlab/html/includes/api_nodes.php`](../../../html/includes/api_nodes.php)](../../../html/includes/api_nodes.php) | `apiNodeStop()` | Tiếp nhận request stop từ router |
| [`[`/opt/unetlab/html/includes/functions.php`](../../../html/includes/functions.php)](../../../html/includes/functions.php) | `nodeStop()` | Quản lý logic gửi tín hiệu và dọn dẹp |
| [`[`/opt/unetlab/scripts/unl_wrapper.php`](../../../scripts/unl_wrapper.php)](../../../scripts/unl_wrapper.php) | `stopNode()` | Gọi wrapper dừng tiến trình |
| [`[`/opt/unetlab/wrappers/unl_wrapper`](../../../wrappers/unl_wrapper)](../../../wrappers/unl_wrapper) | C function | `kill(pid, SIGTERM)` & `kill(pid, SIGKILL)` |
