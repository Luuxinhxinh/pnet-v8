...
| :--- | :--- | :--- |
| [`[`/opt/unetlab/html/includes/api_nodes.php`](../../../html/includes/api_nodes.php)](../../../html/includes/api_nodes.php) | `apiNodeWipe()` | Kiểm tra node đã stop và điều phối wipe |
| [`[`/opt/unetlab/html/includes/functions.php`](../../../html/includes/functions.php)](../../../html/includes/functions.php) | `nodeWipe()` | Xóa các tệp đĩa tạm và nvram |
| [`[`/opt/unetlab/scripts/unl_wrapper.php`](../../../scripts/unl_wrapper.php)](../../../scripts/unl_wrapper.php) | `wipeNode()` | Thực hiện thao tác xóa an toàn qua quyền root |
