...
| :--- | :--- | :--- |
| [`[`/opt/unetlab/html/includes/api_uusers.php`](../../../html/includes/api_uusers.php)](../../../html/includes/api_uusers.php) | `apiUserAdd()`, `apiUserEdit()`, `apiUserDelete()` | Nghiệp vụ quản lý user và gán POD |
| [`[`/opt/unetlab/html/users/api.php`](../../../html/users/api.php)](../../../html/users/api.php) | PHP API | Endpoint phục vụ giao diện quản trị user |
| [`[`/opt/unetlab/html/main/js/users.js`](../../../html/main/js/users.js)](../../../html/main/js/users.js) | JavaScript | Giao diện bảng danh sách tài khoản người dùng |
