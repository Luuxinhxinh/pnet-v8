...
| :--- | :--- | :--- |
| [`[`/opt/unetlab/html/console/token_mint.php`](../../../html/console/token_mint.php)](../../../html/console/token_mint.php) | `mintConsoleToken()` | Sinh token HMAC có thời hạn |
| [`[`/opt/pnet-webconsole/backend/http_ws_bridge.py`](../../../../pnet-webconsole/backend/http_ws_bridge.py)](../../../../pnet-webconsole/backend/http_ws_bridge.py) | `verify_token()` | Giải mã và kiểm tra tính hợp lệ của token |
