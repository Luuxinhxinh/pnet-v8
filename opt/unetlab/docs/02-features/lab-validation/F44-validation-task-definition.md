...
| :--- | :--- | :--- |
| [`[`/opt/unetlab/html/includes/lab_tasks_unl.php`](../../../html/includes/lab_tasks_unl.php)](../../../html/includes/lab_tasks_unl.php) | `class LabTasks`, `getTasks()`, `setTasks()` | Phân tích và quản lý thẻ `<tasks>` |
| [`[`/opt/unetlab/html/includes/__lab.php`](../../../html/includes/__lab.php)](../../../html/includes/__lab.php) | `Lab::getTasks()` | Tích hợp vào đối tượng Lab chính |
