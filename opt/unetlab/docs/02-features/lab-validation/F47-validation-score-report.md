...
| :--- | :--- | :--- |
| [`[`/opt/unetlab/html/includes/lab_validation_store.php`](../../../html/includes/lab_validation_store.php)](../../../html/includes/lab_validation_store.php) | `LabValidationStore`, `saveScore()`, `getScore()` | Tầng lưu trữ và tính toán điểm số (36KB) |
| [`[`/opt/unetlab/html/themes/default/js/validate.js`](../../../html/themes/default/js/validate.js)](../../../html/themes/default/js/validate.js) | `renderScoreboard()`, `updateProgressBar()` | Giao diện hiển thị bảng điểm |
