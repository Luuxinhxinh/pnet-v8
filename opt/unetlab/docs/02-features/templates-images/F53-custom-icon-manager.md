...
1. **Duyệt Thư viện Biểu tượng**:
   - `images-icons/api.php` quét toàn bộ thư mục [`[`/opt/unetlab/html/images/icons`](../../../html/images/icons)](../../../html/images/icons)/`.
...
| :--- | :--- | :--- |
| [`[`/opt/unetlab/html/images-icons/api.php`](../../../html/images-icons/api.php)](../../../html/images-icons/api.php) | PHP API | Quản lý duyệt và tải lên icon |
| [`[`/opt/unetlab/html/themes/default/js/pnetlab-template-icons.json`](../../../html/themes/default/js/pnetlab-template-icons.json)](../../../html/themes/default/js/pnetlab-template-icons.json)| Config JSON | Danh mục ánh xạ icon thiết bị |
