...
2. **Kích hoạt Tiến trình Tải Ngầm (Background Worker)**:
   ...
   - API gọi kịch bản nền: `nohup [`[`/opt/unetlab/scripts/workers/ishare2.sh`](../../../scripts/workers/ishare2.sh)](../../../scripts/workers/ishare2.sh) --download <image_id> > /tmp/ishare.log 2>&1 &`.
...
| :--- | :--- | :--- |
| [`[`/opt/unetlab/html/ishare2/api.php`](../../../html/ishare2/api.php)](../../../html/ishare2/api.php) | PHP API | API giao tiếp với kho IShare2 Cloud |
| [`[`/opt/unetlab/scripts/workers/ishare2.sh`](../../../scripts/workers/ishare2.sh)](../../../scripts/workers/ishare2.sh) | Shell Script (7.8KB) | Worker chạy ngầm tải và giải nén image |
| [`[`/opt/unetlab/html/main/js/images.js`](../../../html/main/js/images.js)](../../../html/main/js/images.js) | JavaScript | Giao diện kho IShare2 Store |
