...
4. **Bộ Sửa Quyền Hệ thống (Fix Permissions Hook)**:
   - Khi tải image mới lên qua WinSCP thường bị sai quyền root:root -> Chức năng "Fix Permissions" gọi lệnh: [`[`/opt/unetlab/wrappers/unl_wrapper`](../../../wrappers/unl_wrapper)](../../../wrappers/unl_wrapper) -a fixpermissions` để khôi phục quyền `chown -R root:unl` và gán setuid.
...
| :--- | :--- | :--- |
| [`[`/opt/unetlab/html/images-manage/api.php`](../../../html/images-manage/api.php)](../../../html/images-manage/api.php) | PHP API | API quét danh sách và xóa image |
| [`[`/opt/unetlab/html/main/js/images.js`](../../../html/main/js/images.js)](../../../html/main/js/images.js) | JavaScript | Giao diện quản lý bảng image |
| [`[`/opt/unetlab/wrappers/unl_wrapper`](../../../wrappers/unl_wrapper)](../../../wrappers/unl_wrapper) | C binary | Tùy chọn `-a fixpermissions` sửa quyền đĩa |
