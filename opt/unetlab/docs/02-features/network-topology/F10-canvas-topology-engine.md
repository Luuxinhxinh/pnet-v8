...
| :--- | :--- | :--- |
| [`[`/opt/unetlab/html/includes/api_topology.php`](../../../html/includes/api_topology.php)](../../../html/includes/api_topology.php) | `apiTopologyGet()` | Tính toán ma trận kết nối và trả về JSON đồ thị |
| [`[`/opt/unetlab/html/themes/default/js/javascript.js`](../../../html/themes/default/js/javascript.js)](../../../html/themes/default/js/javascript.js) | `drawTopology()`, `initCanvas()`, `handleDrag()` | Vòng lặp vẽ và quản lý sự kiện chuột |
| [`[`/opt/unetlab/html/themes/default/js/pnetlab-pan-button.js`](../../../html/themes/default/js/pnetlab-pan-button.js)](../../../html/themes/default/js/pnetlab-pan-button.js) | `handlePan()` | Xử lý di chuyển khung nhìn |
