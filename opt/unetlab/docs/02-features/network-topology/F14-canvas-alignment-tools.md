...
| :--- | :--- | :--- |
| [`[`/opt/unetlab/html/themes/default/js/pnetlab-align-distribute.js`](../../../html/themes/default/js/pnetlab-align-distribute.js)](../../../html/themes/default/js/pnetlab-align-distribute.js) | `alignNodes()`, `distributeNodes()` | Thuật toán toán học căn chỉnh vị trí |
| [`[`/opt/unetlab/html/themes/default/js/pnetlab-node-duplicate.js`](../../../html/themes/default/js/pnetlab-node-duplicate.js)](../../../html/themes/default/js/pnetlab-node-duplicate.js) | `duplicateSelectedNodes()` | Xử lý nhân bản cấu hình thiết bị |
| [`[`/opt/unetlab/html/includes/api_nodes.php`](../../../html/includes/api_nodes.php)](../../../html/includes/api_nodes.php) | `apiNodeAdd()` | Tiếp nhận tạo node bản sao |
