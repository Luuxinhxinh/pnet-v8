...
| :--- | :--- | :--- |
| [`[`/opt/unetlab/html/themes/default/js/pnetlab-shape-draw.js`](../../../html/themes/default/js/pnetlab-shape-draw.js)](../../../html/themes/default/js/pnetlab-shape-draw.js) | `drawCustomShape()`, `initShapeTool()` | Bộ công cụ vẽ vector hình khối |
| [`[`/opt/unetlab/html/includes/api_textobjects.php`](../../../html/includes/api_textobjects.php)](../../../html/includes/api_textobjects.php) | `apiTextobjectAdd()` | Lưu thông số hình khối và văn bản vào lab |
| [`[`/opt/unetlab/html/includes/__textobject.php`](../../../html/includes/__textobject.php)](../../../html/includes/__textobject.php) | `class Textobject` | Mô hình dữ liệu thẻ XML của text/shape |
