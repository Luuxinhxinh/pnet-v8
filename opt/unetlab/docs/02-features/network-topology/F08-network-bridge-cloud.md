...
| :--- | :--- | :--- |
| [`[`/opt/unetlab/html/includes/api_networks.php`](../../../html/includes/api_networks.php)](../../../html/includes/api_networks.php) | `apiNetworkAdd()`, `apiNetworkEdit()` | Xử lý yêu cầu tạo/sửa đối tượng Network |
| [`[`/opt/unetlab/html/includes/__network.php`](../../../html/includes/__network.php)](../../../html/includes/__network.php) | `class Network` | Mô hình dữ liệu Network trong Lab XML |
| [`[`/opt/unetlab/html/includes/functions.php`](../../../html/includes/functions.php)](../../../html/includes/functions.php) | `networkStart()`, `checkNetwork()` | Tạo bridge và quản lý giao diện kernel |
