...
| :--- | :--- | :--- |
| [`[`/opt/unetlab/html/api.php`](../../../html/api.php)](../../../html/api.php) | `$app->get("/api/workbook/pdf/(:name)")` | API phục vụ luồng file PDF |
| [`[`/opt/unetlab/html/includes/Parsedown.php`](../../../html/includes/Parsedown.php)](../../../html/includes/Parsedown.php) | `class Parsedown` | Bộ phân tích cú pháp nếu tài liệu là Markdown (.md) |
| [`[`/opt/unetlab/html/themes/default/js/pnetlab-sidebar-tools.js`](../../../html/themes/default/js/pnetlab-sidebar-tools.js)](../../../html/themes/default/js/pnetlab-sidebar-tools.js) | `toggleWorkbookPane()` | Điều khiển ẩn hiện khung xem tài liệu |
