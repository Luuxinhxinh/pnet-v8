...
| :--- | :--- | :--- |
| [`[`/opt/unetlab/html/includes/__lab.php`](../../../html/includes/__lab.php)](../../../html/includes/__lab.php) | `class Lab`, `save()`, `getNodes()` | Lõi đọc và ghi XML (100KB code) |
| [`[`/opt/unetlab/html/includes/__node.php`](../../../html/includes/__node.php)](../../../html/includes/__node.php) | `class Node` | Đọc ghi thuộc tính node XML |
| [`[`/opt/unetlab/html/includes/__network.php`](../../../html/includes/__network.php)](../../../html/includes/__network.php) | `class Network` | Đọc ghi thuộc tính network XML |
