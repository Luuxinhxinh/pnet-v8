...
| :--- | :--- | :--- |
| [`[`/opt/unetlab/html/import/api.php`](../../../html/import/api.php)](../../../html/import/api.php) | `convertCmlToUnl()` | Điều phối chuyển đổi file CML sang UNL |
| [`[`/opt/unetlab/html/includes/__lab.php`](../../../html/includes/__lab.php)](../../../html/includes/__lab.php) | `buildFromCmlArray()` | Dựng cây đối tượng Lab từ dữ liệu CML |
