...
2. **Quy trình Nhập Khẩu (Import ZIP)**:
   ...
   - Kích hoạt worker nền [`[`/opt/unetlab/scripts/workers/import.sh`](../../../scripts/workers/import.sh)](../../../scripts/workers/import.sh).
...
| :--- | :--- | :--- |
| [`[`/opt/unetlab/html/api.php`](../../../html/api.php)](../../../html/api.php) | `$app->post("/api/export")` | Tiếp nhận yêu cầu xuất file ZIP |
| [`[`/opt/unetlab/html/import/api.php`](../../../html/import/api.php)](../../../html/import/api.php) | PHP API | Tiếp nhận upload file ZIP bài lab |
| [`[`/opt/unetlab/scripts/workers/import.sh`](../../../scripts/workers/import.sh)](../../../scripts/workers/import.sh) | Shell Script (12KB) | Worker giải nén và phân quyền an toàn |
