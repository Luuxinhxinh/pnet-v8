...
| :--- | :--- | :--- |
| [`[`/opt/unetlab/scripts/pnet-satellite-join`](../../../scripts/pnet-satellite-join)](../../../scripts/pnet-satellite-join) | Shell Script | Kịch bản dòng lệnh thực hiện quy trình join |
| [`[`/opt/unetlab/scripts/pnetlab-satd.py`](../../../scripts/pnetlab-satd.py)](../../../scripts/pnetlab-satd.py) | Python (14KB) | Daemon chạy trên vệ tinh để nhận lệnh |
| [`[`/opt/unetlab/html/cluster/api.php`](../../../html/cluster/api.php)](../../../html/cluster/api.php) | PHP | API tiếp nhận đăng ký vệ tinh trên Master |
