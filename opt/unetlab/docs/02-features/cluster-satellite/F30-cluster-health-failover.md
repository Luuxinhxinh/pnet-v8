...
| :--- | :--- | :--- |
| [`[`/opt/unetlab/scripts/pnetlab-brokerd.py`](../../../scripts/pnetlab-brokerd.py)](../../../scripts/pnetlab-brokerd.py) | `check_satellite_heartbeats()` | Vòng lặp kiểm tra nhịp tim |
| [`[`/opt/unetlab/html/cluster/api.php`](../../../html/cluster/api.php)](../../../html/cluster/api.php) | `getClusterStatus()` | Trả về tình trạng sức khỏe cụm |
| [`[`/opt/unetlab/html/main/js/clusters.js`](../../../html/main/js/clusters.js)](../../../html/main/js/clusters.js) | `updateHostStatusHUD()` | Hiển thị chấm tròn xanh/đỏ trạng thái host |
