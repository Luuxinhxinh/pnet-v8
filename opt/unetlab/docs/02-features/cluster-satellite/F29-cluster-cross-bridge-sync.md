...
| :--- | :--- | :--- |
| [`[`/opt/unetlab/scripts/pnetlab-brokerd.py`](../../../scripts/pnetlab-brokerd.py)](../../../scripts/pnetlab-brokerd.py) | `setup_cross_host_link()` | Điều phối tạo VXLAN trên 2 đầu |
| [`[`/opt/unetlab/scripts/pnet-satdeploy.sh`](../../../scripts/pnet-satdeploy.sh)](../../../scripts/pnet-satdeploy.sh) | Shell Script | Cấu hình tham số kernel VXLAN trên vệ tinh |
