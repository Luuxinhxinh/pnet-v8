...
| :--- | :--- | :--- |
| [`[`/opt/unetlab/scripts/sdwan/sdwan-onboard.py`](../../../scripts/sdwan/sdwan-onboard.py)](../../../scripts/sdwan/sdwan-onboard.py) | Python Script (55KB) | Kịch bản tự động hóa xác thực và cài đặt chứng chỉ |
| [`[`/opt/unetlab/scripts/workers/sdwan.sh`](../../../scripts/workers/sdwan.sh)](../../../scripts/workers/sdwan.sh) | Shell Script | Worker chạy tiến trình onboarding ngầm |
