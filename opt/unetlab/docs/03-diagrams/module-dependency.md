...
- Tầng Cầu nối WebConsole & WebSockets ([`[`/opt/pnet-webconsole/backend`](../../../pnet-webconsole/backend)](../../../pnet-webconsole/backend)/`)
- Tầng Daemons nền Python (`[`/opt/unetlab/scripts`](../../scripts)/`)
...
| **Tầng WebConsole** | [`[`/opt/pnet-webconsole/backend`](../../../pnet-webconsole/backend)](../../../pnet-webconsole/backend)/` | Node.js, Python asyncio, websockets | `guacd`, raw TCP telnet sockets |
