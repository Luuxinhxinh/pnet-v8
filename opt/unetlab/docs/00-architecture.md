...
sequenceDiagram
    ...
    API->>UNL: sudo [`[`/opt/unetlab/scripts/unl_wrapper.php`](../scripts/unl_wrapper.php)](../scripts/unl_wrapper.php) -a start -d 1
    UNL->>QWRAP: execve([`[`/opt/unetlab/wrappers/qemu_wrapper`](../wrappers/qemu_wrapper)](../wrappers/qemu_wrapper), args)
