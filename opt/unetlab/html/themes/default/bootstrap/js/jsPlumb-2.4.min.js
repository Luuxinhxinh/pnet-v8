    ...
    function() {
        ...
        var o = 0,
            ...
            q = b.jsPlumbInstance = function(f) {
                this.version = "2.4.1", f && r.extend(this.Defaults, f), this.logEnabled = this.Defaults.LogEnabled, this._connectionTypes = {}, this._endpointTypes = {}, d.EventGenerator.apply(this);
                var h = this,
                    i = p(),
                    j = h.bind,
                    l = {},
                ...
                var u = null,
                            ...
                            if (g && r.isDragSupported(a, h)) {
                                ...
                                if (i = r.extend({}, i), r.isAlreadyDraggable(a, h)) c.force && h.initDraggable(a, i);
                                    ...
                                    var j = r.dragEvents.drag,
                                        ...
                                        m = !1;
                                    tb(e, a), i[l] = d.wrap(i[l], function() {
                            ...
                            j = function(a, b, d, e) {
                                if (c[a] && !c[a].endpoint && !c[a + "Endpoint"] && !c.newConnection) {
                                    ...
                                    if (g = g ? g[e] : null) {
                                        ...
                                        c[a + "Endpoint"] = h, !c.scope && g.def.scope && (c.scope = g.def.scope), h.setDeleteOnEmpty(!0), g.uniqueEndpoint && (g.endpoint ? h.finalEndpoint = g.endpoint : (g.endpoint = h, h.setDeleteOnEmpty(!1)))
                                    }
                                }
                            };
                    ...
                    S = function(a, b) {
                        ...
                        var e = new c(d);
                        return e.id = "ep_" + J(), tb(d.elementId, d.source), r.headless || h.getDragManager().endpointAdded(d.source, b), e
                    },
                    T = function(a, b, c) {
                        var d = x[a];
                        if (d && d.length)
                ...
                this.setConnectionBeingDragged = function(a) {
                    ...
                    for (var f = [], g = d.isArray(a) || null != a.length && !d.isString(a) ? a : [a], i = 0, j = g.length; j > i; i++) {
                        e.source = h.getElement(g[i]), rb(e.source);
                        var k = Z(e.source),
                            l = S(e, k),
                            m = tb(k, e.source).info.o;
                ...
                this.deleteConnection = function(a, b) {
                    return null != a && (b = b || {}, b.force || d.functionChain(!0, !1, [
                        ...
                        [a, cb, [a]],
                        [h, eb, [db, a]]
                    ])) ? (a.setHover(!1), ab(a, !a.pending && b.fireEvent !== !1, b.originalEvent), a.endpoints[0].detachFromConnection(a), a.endpoints[1].detachFromConnection(a), d.removeWithFunction(w, function(b) {
                        return a.id == b.id
                ...
                var fb = function(a, b, c, d) {
                    ...
                    hb = function(a, b, c) {
                        return function() {
                            return fb(a, b, arguments, c)
                        }
                    },
                    ib = function(a, b) {
                        return function() {
                            return gb(a, b, arguments)
                        }
                    },
                    jb = function(a, b) {
                        var c = [];
                ...
                this.getConnections = function(a, b) {
                    ...
                    for (var c = a.scope || h.getDefaultScope(), d = jb(c, !0), e = jb(a.source), f = jb(a.target), g = !b && d.length > 1 ? {} : [], i = function(a, c) {
                            if (!b && d.length > 1) {
                                var e = g[a];
                        ...
                        kb(d, l.scope) && kb(e, m) && kb(f, n) && i(l.scope, l)
                    }
                    return g
                };
                var lb = function(a, b) {
                    ...
                    nb = function(a, b) {
                        ...
                        for (c = 0, d = f.length; d > c; c++) e[f[c]] = hb(a, f[c], b);
                        for (c = 0, d = g.length; d > c; c++) e[g[c]] = ib(a, g[c]);
                        return e
                    },
                    ob = function(a) {
                        var b = nb(a, ob);
                        return r.extend(b, {
                            setDetachable: hb(a, "setDetachable", ob),
                            setReattach: hb(a, "setReattach", ob),
                            setConnector: hb(a, "setConnector", ob),
                            "delete": function() {
                                for (var b = 0, c = a.length; c > b; b++) h.deleteConnection(a[b])
                            },
                            isDetachable: ib(a, "isDetachable"),
                            isReattach: ib(a, "isReattach")
                        })
                    },
                    pb = function(a) {
                        var b = nb(a, pb);
                        return r.extend(b, {
                            setEnabled: hb(a, "setEnabled", pb),
                            setAnchor: hb(a, "setAnchor", pb),
                            isEnabled: ib(a, "isEnabled"),
                ...
                this.select = function(a) {
                    return a = a || {}, a.scope = a.scope || "*", ob(a.connections || h.getConnections(a, !0))
                ...
                var rb = function(a) {
                    ...
                    ub = this.updateOffset = function(a) {
                        var b, c = a.timestamp,
                            d = a.recalc,
                            e = a.offset,
                            f = a.elId;
                ...
                this.init = function() {
                    ...
                    v || (sb(), h.anchorManager = new b.jsPlumb.AnchorManager({
                        jsPlumbInstance: h
                    }), v = !0, h.fire("ready", h))
                ...
                this.makeTarget = function(a, c, d) {
                    ...
                    for (var f = e.maxConnections || -1, g = function(a) {
                            ...
                            this.targetEndpointDefinitions[d] = this.targetEndpointDefinitions[d] || {}, rb(d), c.el._isJsPlumbGroup && null == g.rank && (g.rank = -1);
                            var i = {
                            ...
                            c.def = i, this.targetEndpointDefinitions[d][h] = i, wb(c, e, g, e.isSource === !0, !0), c.el._katavorioDrop[c.el._katavorioDrop.length - 1].targetDef = i
                    ...
                    for (var j = f.maxConnections || -1, k = f.onMaxConnections, l = function(a) {
                            ...
                            this.sourceEndpointDefinitions[c] = this.sourceEndpointDefinitions[c] || {}, rb(c);
                            var i = {
                                ...
                                if (3 !== i.which && 2 !== i.button) {
                                    ...
                                    if (l.enabled) {
                                        if (c = this.getId(this.getElement(a.el)), f.filter) {
                                            var m = d.isString(f.filter) ? vb(i, a.el, f.filter, this, f.filterExclude) : f.filter(i, a.el);
                                            if (m === !1) return
                                        }
                                        var p = this.select({
                                            source: c
                                        ...
                                        var q = b.jsPlumb.getPositionOnElement(i, e, n),
                                            t = {};
                                        b.jsPlumb.extend(t, f), t.isTemporarySource = !0, t.anchor = [q[0], q[1], 0, 0], t.dragOptions = o, l.def.scope && (t.scope = l.def.scope), r = this.addEndpoint(c, t), s = !0, r.setDeleteOnEmpty(!0), l.uniqueEndpoint && (l.endpoint ? r.finalEndpoint = l.endpoint : (l.endpoint = r, r.setDeleteOnEmpty(!1)));
                                        var u = function() {
                ...
                this.getScope = function(a) {
                    return xb(a, ["sourceEndpointDefinitions", "targetEndpointDefinitions"])
                }, this.getSourceScope = function(a) {
                    return xb(a, "sourceEndpointDefinitions")
                }, this.getTargetScope = function(a) {
                    return xb(a, "targetEndpointDefinitions")
                }, this.setScope = function(a, b, c) {
                    this.setSourceScope(a, b, c), this.setTargetScope(a, b, c)
                }, this.setSourceScope = function(a, b, c) {
                    yb(a, b, "sourceEndpointDefinitions", c), this.setDragScope(a, b)
                }, this.setTargetScope = function(a, b, c) {
                    yb(a, b, "targetEndpointDefinitions", c), this.setDropScope(a, b)
                ...
                this.toggleSourceEnabled = function(a, b) {
                    return zb("source", a, null, !0, b), this.isSourceEnabled(a, b)
                }, this.setSourceEnabled = function(a, b, c) {
                    return zb("source", a, b, null, c)
                }, this.isSource = function(a, b) {
                    return b = b || "default", Ab(a, function(a) {
                    ...
                    return zb("target", a, null, !0, b), this.isTargetEnabled(a, b)
                ...
                this.repaint = function(a, b, c) {
                    ...
                    return Bb(a, function(a) {
                        ...
                        h.updateOffset({
                            ...
                            recalc: !0,
                            timestamp: b
                        }), h.getDragManager().updateOffsets(d), h.repaint(a)
                    })
                ...
                this.remove = function(a, b) {
                    ...
                    h.silently(function() {
                        qb = !1, h.removeAllGroups(), h.removeGroupManager(), h.deleteEveryEndpoint(), h.unbind(), this.targetEndpointDefinitions = {}, this.sourceEndpointDefinitions = {}, w.length = 0, this.doReset && this.doReset()
                    }.bind(this))
                };
                var Db = function(a) {
                ...
                this.clear = function() {
                    h.select().each(Db), h.selectEndpoints().each(Db), x = {}, y = {}
    ...
    function() {
        ...
        b.Endpoint = function(a) {
            ...
            this.bind("mouseover", function() {
                ...
                for (var d = b.length, e = 0; d > e; e++) i.deleteConnection(b[0]);
                return this
